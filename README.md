...
Generated from Claude Code **v2.1.207** — 439 flags across 18 categories.
...
| `CLAUDE_CODE_AUTH_FAIL_EXIT_MS` | number | — |
...
| `CLAUDE_CODE_DESIGN_OAUTH_CLIENT_ID` | text | — |
...
| `CLAUDE_CODE_AUTO_MODE_PRIOR_ASSISTANT_CONTEXT` | text | — |
| `CLAUDE_CODE_AUTO_MODE_SIBLING_CONTEXT` | text | — |
| `CLAUDE_CODE_COLD_COMPACT` | text | Forces a cold compaction run regardless of current context fill level. |
| `CLAUDE_CODE_COORDINATOR_PROPAGATE_NESTED_MEMORY` | text | — |
...
| `CLAUDE_CODE_DISABLE_MEMORY_PERIODIC_RESYNC` | boolean | — |
| `CLAUDE_CODE_DISABLE_NESTED_CHAIN_IDLE` | boolean | — |
...
| `CLAUDE_CODE_MCP_TOOL_IDLE_TIMEOUT` | number | — |
...
| `CLAUDE_CODE_FRAME_TIMING_SAMPLE_EVERY` | text | — |
...
| `CLAUDE_CODE_HIDE_SETTINGS_HINT` | text | — |
...
| `ANTHROPIC_DEFAULT_FABLE_MODEL` | text | — |
| `ANTHROPIC_DEFAULT_FABLE_MODEL_DESCRIPTION` | text | — |
| `ANTHROPIC_DEFAULT_FABLE_MODEL_NAME` | text | — |
| `ANTHROPIC_DEFAULT_FABLE_MODEL_SUPPORTED_CAPABILITIES` | text | — |
...
| `CLAUDE_CODE_SUBAGENT_CACHE_EVICT` | text | — |
...
| `CLAUDE_CODE_MCP_AUTO_BACKGROUND_MS` | number | — |
...
| `CLAUDE_CODE_PLUGIN_BINARY_ASSETS` | text | — |
...
| `CLAUDE_CODE_SKIP_PLUGIN_MCP_SERVERS` | boolean | — |
| `CLAUDE_CODE_SKIP_PLUGIN_MCP_SERVERS_EXCEPT` | boolean | — |
...
| `CLAUDE_CODE_SYNC_PLUGINS_BUFFERED_DOWNLOAD` | text | — |
| `CLAUDE_CODE_SYNC_PLUGINS_DOWNLOAD_STALL_MS` | number | — |
...
| `CLAUDE_CODE_TERMINAL_MCP_TOOLS` | text | — |

## Networking & Proxy

| Flag | Type | Description |
|------|------|-------------|
| `CLAUDE_CODE_AGENT_PROXY_GH_SHIM` | text | — |
| `CLAUDE_CODE_AGENT_PROXY_GIT_CONFIG` | text | — |
...
| `CLAUDE_CODE_WEBFETCH_USE_CCR_PROXY` | text | — |
| `CLAUDE_CODE_WEBSEARCH_USE_CCR_PROXY` | text | — |
...
| `CLAUDE_CODE_ENABLE_MORNING_BRIEF` 🆕 | boolean | — |
...
| `CLAUDE_CODE_MORNING_BRIEF_PROMPT` 🆕 | text | — |
...
| `CLAUDE_CODE_RELAUNCH_TERMINAL_SIZE` | text | — |
...
| `CLAUDE_CODE_ENABLE_REMOTE_RECAP` | boolean | — |
...
| `CLAUDE_CODE_REMOTE_HERMETIC_MODE` | text | — |
...
| `CLAUDE_CODE_DISABLE_BG_SHELL_PRESSURE_REAP` | boolean | — |
...
| `CLAUDE_CODE_TEAM_TEARDOWN_PARK_TIMEOUT_MS` | number | — |
...
| `CLAUDE_CODE_OTEL_DIAG_STDERR` | text | — |
...
| `CLAUDE_CODE_ALTGR_AS_TEXT` | text | — |
| `CLAUDE_CODE_ARTIFACT` | text | — |
| `CLAUDE_CODE_ARTIFACT_AUTO_OPEN` | text | — |
| `CLAUDE_CODE_ARTIFACT_DIRECT_UPLOAD` | text | — |
| `CLAUDE_CODE_ARTIFACTS_API_BASE_URL` | text | — |
| `CLAUDE_CODE_ASSUME_FIRST_PARTY_BASE_URL` | text | — |
| `CLAUDE_CODE_AUTO_BACKGROUND_TIMEOUT_MS` | number | — |
| `CLAUDE_CODE_AUTO_MODE_CLASSIFY_EDITS` | text | — |
| `CLAUDE_CODE_AUTO_MODE_EDIT_REMOVAL` | text | — |
| `CLAUDE_CODE_AUTO_MODE_EDIT_REMOVAL_CAP` | text | — |
...
| `CLAUDE_CODE_AUTO_MODE_GIT_STATUS` | text | — |
| `CLAUDE_CODE_AUTO_MODE_GIT_STATUS_LIMIT` | text | — |
| `CLAUDE_CODE_AUTO_MODE_GIT_STATUS_UPLOADS` | text | — |
| `CLAUDE_CODE_AUTO_MODE_OUTCOME_CODES` | text | — |
| `CLAUDE_CODE_AUTO_MODE_REPO_VISIBILITY` | text | — |
| `CLAUDE_CODE_AUTO_MODE_TEMPERATURE` | text | — |
| `CLAUDE_CODE_AWS_CHAIN_RESOLVE_TIMEOUT_MS` 🆕 | number | — |
| `CLAUDE_CODE_BASALT_COVE` | text | — |
| `CLAUDE_CODE_BENCH_LIVE_COUNTS` | text | Enables live token/turn counters in the terminal UI for benchmarking. |
| `CLAUDE_CODE_BRIDGE_SESSION_ID` | text | — |
| `CLAUDE_CODE_CHILD_SESSION` | text | — |
| `CLAUDE_CODE_CLASSIFIER_SUMMARY` | text | Forces the post-turn classifier into LLM mode when truthy, heuristic when falsy. |
| `CLAUDE_CODE_COORDINATOR_EXTRA_TOOLS` | text | — |
...
| `CLAUDE_CODE_DISABLE_ARTIFACT` | boolean | — |
| `CLAUDE_CODE_DISABLE_BG_EXIT_HANDOFF` | boolean | — |
| `CLAUDE_CODE_DISABLE_BUNDLED_SKILLS` | boolean | — |
| `CLAUDE_CODE_DISABLE_CLAUDE_CODE_SKILL` | boolean | Disables the built-in slash command for Claude Code documentation. |
| `CLAUDE_CODE_DISABLE_LAUNCH_COMPOSER` | boolean | — |
| `CLAUDE_CODE_DISABLE_MOUSE_CLICKS` | boolean | — |
| `CLAUDE_CODE_DISABLE_NOTIFICATION_PRESENCE_CHECK` | boolean | — |
...
| `CLAUDE_CODE_DISABLE_WORKING_SYNC` | boolean | — |
| `CLAUDE_CODE_DOWNLOAD_DEADLINE_MS_FOR_TESTING` | text | — |
...
| `CLAUDE_CODE_ENABLE_DESIGN_SYNC` | boolean | — |
| `CLAUDE_CODE_ENABLE_LAUNCH_COMPOSER` | boolean | — |
| `CLAUDE_CODE_ENABLE_MENU_KIND_LANES` | boolean | — |
| `CLAUDE_CODE_EXPERIMENTAL_OBSERVER_AGENTS` | text | — |
| `CLAUDE_CODE_FABLE_BRIDGE_DIALOG_TIMEOUT_MS` | number | — |
| `CLAUDE_CODE_FLEET_PAST_SESSIONS` | text | — |
...
| `CLAUDE_CODE_FORCE_STRIKETHROUGH` | boolean | — |
...
| `CLAUDE_CODE_GZIP_REQUEST_BODIES` | text | — |
| `CLAUDE_CODE_HOST_CREDS_FILE` | text | — |
...
| `CLAUDE_CODE_LANTERN_PRISM` 🆕 | text | — |
...
| `CLAUDE_CODE_PARKED_PERMISSION_WAIT_MS` | number | — |
| `CLAUDE_CODE_PEWTER_OWL` | text | Activates the Pewter Owl experiment cohort, enabling its associated feature variant. |
| `CLAUDE_CODE_PEWTER_OWL_TOOL` | text | — |
| `CLAUDE_CODE_POWERUP_ONBOARDING` | text | — |
| `CLAUDE_CODE_PRINT_BG_WAIT_CEILING_MS` | number | — |
...
| `CLAUDE_CODE_SKILL_DESC_REFRAME` | text | — |
...
| `CLAUDE_CODE_SKIP_AWS_CRED_CACHE` 🆕 | boolean | — |
...
| `CLAUDE_CODE_SYNC_SKILLS_INSTALL_TIMEOUT_MS` | number | — |
...
| `CLAUDE_CODE_TODO_REMINDER_MODE` | text | — |
| `CLAUDE_CODE_TOTAL_TOKENS_REMINDER` | text | — |
| `CLAUDE_CODE_TOTAL_TOKENS_REMINDER_AFTER_USER_TURN` | text | — |
| `CLAUDE_CODE_TOTAL_TOKENS_REMINDER_BUDGET` | text | — |
| `CLAUDE_CODE_TRIGGER_ID` 🆕 | text | — |
...
| `CLAUDE_CODE_USER_DIALOG_TIMEOUT_MS` | number | — |
...
| `CLAUDE_CODE_WALNUT_SPIRE` 🆕 | text | — |
| `CLAUDE_CODE_WORKFLOW_SIZE_WARNING_AGENTS` | text | — |
| `CLAUDE_CODE_WORKFLOW_SIZE_WARNING_TOKENS` | text | — |
