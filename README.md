...
Generated from Claude Code **v2.1.282** — 725 flags across 18 categories.
...
| `CLAUDE_CODE_DISABLE_MEMORY_RO_UNSAVED_NOTICEH` 🆕 | boolean | — |
...
| `CLAUDE_CODE_POST_TURN_MEMORY_SYNC` | text | — |
...
| `CLAUDE_CODE_THINKING_DISPLAY_UPDATESN` 🆕 | text | — |
...
| `CLAUDE_CODE_DISABLE_MCP_TASK_BACKGROUND` | boolean | — |
...
| `CLAUDE_CODE_ENABLE_REFRESH_MCP_TOOLSA` 🆕 | boolean | — |
...
| `CLAUDE_CODE_MAX_MCP_DESCRIPTION_LENGTH` | number | — |
...
| `CLAUDE_CODE_WEBSEARCH_CCR_PROXY_FAST` 🆕 | text | — |
...
| Flag | Type | Description |
|------|------|-------------|
| `CLAUDE_CODE_CCR_EARLY_REMOTE_CONNECT` | text | — |
...
| `CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMSV` | text | — |
...
| `CLAUDE_CODE_ARTIFACT_OPEN_ACTIONC` 🆕 | text | — |
...
| `CLAUDE_CODE_DIR_SYNC_CHAIN` | text | — |
...
| `CLAUDE_CODE_DISABLE_ADVISOR_TOOLB` 🆕 | boolean | — |
...
| `CLAUDE_CODE_DISABLE_REFUSAL_FALLBACKO` 🆕 | boolean | — |
...
| `CLAUDE_CODE_ENABLE_EXPERIMENTAL_ADVISOR_TOOLA` 🆕 | boolean | — |
...
| `CLAUDE_CODE_EXPERIMENTAL_OBSERVER_AGENTSM` 🆕 | text | — |
...
| `CLAUDE_CODE_HOLD_REPORT_PARK_AT_INITG` 🆕 | text | — |
...
| `CLAUDE_CODE_INLINE_TOOLSM` 🆕 | text | — |
...
| `CLAUDE_CODE_PROJECTS_SESSION` 🆕 | text | — |
...
| `CLAUDE_CODE_SILENT_TURN_REMINDERH` 🆕 | text | — |
...
| Flag | Removed in |
|------|------------|
| `ANTHROPIC_BASE_URLT` | 2.1.246 |
| `ANTHROPIC_BEDROCK_MANTLE_API_KEY` | 2.1.210 |
| `ANTHROPIC_BEDROCK_MANTLE_BASE_URLA` | 2.1.239 |
| `ANTHROPIC_BEDROCK_SERVICE_TIERW` | 2.1.246 |
| `ANTHROPIC_CONFIG_DIRW` | 2.1.246 |
| `ANTHROPIC_CUSTOM_HEADERSI` | 2.1.215 |
| `ANTHROPIC_CUSTOM_HEADERSIR` | 2.1.224 |
| `ANTHROPIC_CUSTOM_MODEL_OPTION_DESCRIPTIONM` | 2.1.215 |
| `ANTHROPIC_CUSTOM_MODEL_OPTION_NAMEI` | 2.1.246 |
| `ANTHROPIC_CUSTOM_MODEL_OPTION_SUPPORTED_CAPABILITIESW` | 2.1.246 |
| `ANTHROPIC_DEFAULT_FABLE_MODEL_NAMEW` | 2.1.246 |
| `ANTHROPIC_DEFAULT_FABLE_MODELH` | 2.1.246 |
...
| `CLAUDE_CODE_DISABLE_MOUSE_CLICKSC` | 2.1.280 |
| `CLAUDE_CODE_DISABLE_MOUSEW` | 2.1.222 |
| `CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFICI` | 2.1.224 |
| `CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFICODE_TOTA` | 2.1.246 |
| `CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFICONFIG` | 2.1.246 |
...
| `CLAUDE_CODE_ENTRYPOINTK` | 2.1.246 |
...
| `CLAUDE_CODE_FORCE_MID_CONVERSATION_SYSTEML` | 2.1.246 |
...
| `CLAUDE_CODE_OTEL_DIAG_STDERRW` | 2.1.246 |
| `CLAUDE_CODE_OTEL_FLUSH_TIMEOUT_MSE` | 2.1.246 |
...
| `CLAUDE_CODE_PROVIDER_MANAGED_BY_HOSTW` | 2.1.246 |
...
| `CLAUDE_CODE_USE_VERTEXW` | 2.1.246 |
